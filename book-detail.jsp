            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <h5 class="text-muted mb-3">Penulis: <c:out value="${book.author}" /></h5>

                        <table class="table table-borderless">
                            <tr>
                                <th style="width: 150px;">Genre</th>
                                <td>: <span class="badge bg-info text-dark"><c:out value="${book.genre}" /></span></td>
                            </tr>
                            <tr>
                                <th>Stok Tersedia</th>
                                <td>: 
                                    <c:choose>
                                        <c:when test="${book.stock > 0}">
                                            <span class="badge bg-success"><c:out value="${book.stock}" /> Eksemplar</span>
                                        </c:when>
                                        <c:otherwise>
                            ...
                            <tr>
                                <th>Deskripsi</th>
                                <td>: <p class="text-justify"><c:out value="${book.description}" /></p></td>
                            </tr>
                        </table>
